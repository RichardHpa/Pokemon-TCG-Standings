    ...
    return (
        <div className="flex flex-col gap-4">
            <p className="text-center">
                Follow TCG players from around the world as they complete to be
                ...
                <div className="flex flex-col gap-4">
                    {tournament ? (
                        <>
                            ...
                            {showStandings.includes(
                                tournament.tournamentStatus
                            ) ? (
                                <>
                                    <Tabs>
                                        <Tab
                                            active={division === 'masters'}
                                            onClick={() =>
                                                changeDivision('masters')
                                            }
                                        >
                                            Masters
                                        </Tab>
                                        <Tab
                                            active={division === 'seniors'}
                                            onClick={() =>
                                                changeDivision('seniors')
                                            }
                                        >
                                            Seniors
                                        </Tab>
                                        <Tab
                                            active={division === 'juniors'}
                                            onClick={() =>
                                                changeDivision('juniors')
                                            }
                                        >
                                            Juniors
                                        </Tab>
                                ...
                                <p className="mb-1 italic text-gray-500 dark:text-gray-400 text-center">
                                    Current Standings will be shown once the
                                    tournament starts.
                                </p>
                            )}
                        </>
                        ...
                        <Notice status="warning">
                            There seems to be an error retrieving the data for
                            this tournament. This often happens when to many
                            people are trying to access the data at the same
                            time. Please try again in a few minutes.
                            <br />
                            If the problem persists, I will look into hosting my
                            own api to prevent this from happening in the
                            future, though this will take some time and money.
                        </Notice>
                    )}
                </div>
            )}
