...
export const StandingsList = forwardRef(({ standings, tournamentId }: StandingsListProps, ref) => {
  ...
  const onRowClick = useCallback(
    (player: string) => {
      navigate(`/tournaments/${tournamentId}/${createPlayerUrl(player)}`);
    },
                  ...
                  >
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <PinPlayer
                        ...
                        player={createPlayerUrl(data[index].name)}
                      />
                    </div>
                  </li>
                );
