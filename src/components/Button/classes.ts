export const buttonClasses = {
  base: 'font-medium rounded-lg border focus:z-10 focus:ring-4 focus:outline-none text-center',
  ...
  variant: {
    solid: {
      ...
      secondary: {
        ...
        dark: 'dark:text-gray-400 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-600  dark:focus:ring-gray-700',
      },
    },
    outlined: {
      primary: {
