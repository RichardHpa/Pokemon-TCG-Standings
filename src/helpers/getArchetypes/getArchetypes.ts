...
export const getArchetypes = (decklist: DeckList) => {
  ...
  if (pokemonNames.includes('Arceus VSTAR')) {
    foundArchetype.push({ pokemon: 'Arceus VSTAR', image: pokemonList['arceus'].image });
    if (pokemonNames.includes('Armarouge')) {
      foundArchetype.push({ pokemon: 'Armarouge', image: pokemonList['armarouge'].image });
      ...
      foundArchetype.push({ pokemon: 'Gyarados V', image: pokemonList['gyarados'].image });
    } else if (pokemonNames.includes('Inteleon')) {
      foundArchetype.push({ pokemon: 'Inteleon', image: pokemonList['inteleon'].image });
  ...
  if (pokemonNames.includes('Mew VMAX')) {
    foundArchetype.push({ pokemon: 'Mew VMAX', image: pokemonList['mew'].image });
    if (pokemonNames.includes('Genesect V')) {
      foundArchetype.push({ pokemon: 'Genesect V', image: pokemonList['genesect'].image });
    }
    if (pokemonNames.includes('Meloetta')) {
      foundArchetype.push({ pokemon: 'Meloetta', image: pokemonList['meloetta'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Comfey')) {
    foundArchetype.push({ pokemon: 'Comfey', image: pokemonList['comfey'].image });
    if (pokemonNames.includes('Sableye')) {
      foundArchetype.push({ pokemon: 'Sableye', image: pokemonList['sableye'].image });
    }
    return foundArchetype;
  }
  ...
  if (pokemonNames.includes('Dragapult ex')) {
    ...
    if (pokemonNames.includes('Pidgeot ex')) {
      foundArchetype.push({ pokemon: 'Pidgeot ex', image: pokemonList['pidgeot'].image });
    } else if (pokemonNames.includes('Bibarel')) {
      foundArchetype.push({ pokemon: 'Bibarel', image: pokemonList['bibarel'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Charizard ex')) {
    foundArchetype.push({ pokemon: 'Charizard ex', image: pokemonList['charizard'].image });
    if (pokemonNames.includes('Pidgeot ex')) {
      foundArchetype.push({ pokemon: 'Pidgeot ex', image: pokemonList['pidgeot'].image });
    } else if (pokemonNames.includes('Bibarel')) {
      foundArchetype.push({ pokemon: 'Bibarel', image: pokemonList['bibarel'].image });
  ...
  if (pokemonNames.includes('Lugia V')) {
    foundArchetype.push({ pokemon: 'Lugia', image: pokemonList['lugia'].image });
    if (pokemonNames.includes('Archeops')) {
      foundArchetype.push({ pokemon: 'Archeops', image: pokemonList['archeops'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Chien-Pao ex')) {
    foundArchetype.push({ pokemon: 'Chien-Pao ex', image: pokemonList['chien-pao'].image });
    if (pokemonNames.includes('Baxcalibur')) {
      foundArchetype.push({ pokemon: 'Baxcalibur', image: pokemonList['baxcalibur'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Miraidon ex')) {
    foundArchetype.push({ pokemon: 'Miraidon ex', image: pokemonList['miraidon'].image });
    if (pokemonNames.includes('Flaaffy')) {
      foundArchetype.push({ pokemon: 'Flaaffy', image: pokemonList['flaaffy'].image });
  ...
  if (pokemonNames.includes('Iron Hands ex')) {
    ...
    if (pokemonNames.includes('Iron Crown ex')) {
      foundArchetype.push({ pokemon: 'Icon Crown ex', image: pokemonList['iron-crown'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Gardevoir ex')) {
    foundArchetype.push({ pokemon: 'Gardevoir ex', image: pokemonList['gardevoir'].image });
    if (pokemonNames.includes('Banette ex')) {
      foundArchetype.push({ pokemon: 'Banette ex', image: pokemonList['banette'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Snorlax')) {
    foundArchetype.push({ pokemon: 'Snorlax', image: pokemonList['snorlax'].image });
    if (pokemonNames.includes('Rotom V')) {
      foundArchetype.push({ pokemon: 'Rotom V', image: pokemonList['rotom'].image });
    }
    return foundArchetype;
  }
  ...
  if (pokemonNames.includes('Origin Forme Dialga VSTAR')) {
    ...
    if (pokemonNames.includes('Metang')) {
      foundArchetype.push({ pokemon: 'Metang', image: pokemonList['metang'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Roaring Moon ex')) {
    foundArchetype.push({ pokemon: 'Roaring Moon', image: pokemonList['roaring-moon'].image });
    return foundArchetype;
  }
  ...
  if (pokemonNames.includes('Roaring Moon')) {
    ...
    if (pokemonNames.includes('Dudunsparce')) {
      foundArchetype.push({ pokemon: 'Dudunsparce', image: pokemonList['dudunsparce'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Raging Bolt ex')) {
    foundArchetype.push({ pokemon: 'Raging Bolt ex', image: pokemonList['raging-bolt'].image });
    if (pokemonNames.includes('Sandy Shocks ex')) {
      foundArchetype.push({ pokemon: 'Sandy Shocks ex', image: pokemonList['sandy-shocks'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Gholdengo ex')) {
    foundArchetype.push({ pokemon: 'Gholdengo ex', image: pokemonList['gholdengo'].image });
    return foundArchetype;
  }

  if (pokemonNames.includes('Tinkaton')) {
    foundArchetype.push({ pokemon: 'Tinkaton', image: pokemonList['tinkaton'].image });
    return foundArchetype;
  }

  if (pokemonNames.includes('Espathra ex')) {
    foundArchetype.push({ pokemon: 'Espathra ex', image: pokemonList['espathra'].image });
    if (pokemonNames.includes('Xatu')) {
      foundArchetype.push({ pokemon: 'Xatu', image: pokemonList['xatu'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Klawf')) {
    foundArchetype.push({ pokemon: 'Klawf', image: pokemonList['klawf'].image });
    if (pokemonNames.includes('Brute Bonnet')) {
      foundArchetype.push({ pokemon: 'Brute Bonnet', image: pokemonList['brute-bonnet'].image });
    }
    return foundArchetype;
  }

  if (pokemonNames.includes('Whimsicott VSTAR')) {
    foundArchetype.push({ pokemon: 'Whimsicott VSTAR', image: pokemonList['whimsicott'].image });
    return foundArchetype;
  }
